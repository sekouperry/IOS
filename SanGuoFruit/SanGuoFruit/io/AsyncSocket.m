...
- (BOOL)areStreamsConnected
{
	...
	if (theReadStream != NULL)
	{
		...
		if ( !(s == kCFStreamStatusOpen || s == kCFStreamStatusOpening || s == kCFStreamStatusReading || s == kCFStreamStatusError) )
			return NO;
	}
	else return NO;
	...
	if (theWriteStream != NULL)
	{
		...
		if ( !(s == kCFStreamStatusOpen || s == kCFStreamStatusOpening || s == kCFStreamStatusWriting || s == kCFStreamStatusError) )
			return NO;
	}
	else return NO;
